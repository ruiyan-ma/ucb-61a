...
def reverse_recursive(lst):
    ...
    if not lst:
        ...
        # recursive: last element + handle rest list
...
def distance(city_a, city_b):
    ...
    5.0
    """
    square_dist = (get_lat(city_a) - get_lat(city_b)) ** 2 + \
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    curr_city = make_city("curr_city", lat, lon)
    dist1 = distance(curr_city, city_a)
    dist2 = distance(curr_city, city_b)
