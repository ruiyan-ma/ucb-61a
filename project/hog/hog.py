...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    tens, ones = (score // 10) % 10, score % 10
    return 10 - ones + tens
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while scores[0] < goal and scores[1] < goal:
        ...
        # feral hogs rule: if the number of dice you roll is exactly 2 away
        # (absolute difference) from the number of points you scored on the
        # previous turn, you get 3 extra points for the turn.
        if feral_hogs and abs(num_rolls - prev_points[who]) == 2:
            player_score += 3

        # record the points you scored
        prev_points[who] = points

        # swap if needed
        if is_swap(player_score, opponent_score):
            scores[who] = opponent_score
            scores[other(who)] = player_score
        else:
